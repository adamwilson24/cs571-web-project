...
function About() {
  return (
    <div style={{ background: "#0a0a1a", padding: "80px 0 100px" }}>
      <Container>
        <Row className="align-items-start g-5" style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <Col md={4} className="text-center">
            <div style={{ position: "relative", display: "inline-block", marginBottom: "1.5rem" }}>
              ...
              <img
                src={headshotImg}
                alt="Adam Wilson, Information Science student at UW-Madison"
                style={{
                  width: "180px",
                  height: "180px",
                  borderRadius: "50%",
            ...
            <h1 style={{ color: "#fff", fontWeight: 800, marginBottom: "0.25rem", fontSize: "1.5rem" }}>
              Adam Wilson
            </h1>
          ...
          <Col md={8}>
            <section aria-label="About Adam Wilson">
              ...
              <p style={{ color: "rgba(255,255,255,0.65)", lineHeight: "1.9", marginBottom: "2.5rem" }}>
                I'm always looking for opportunities to work on interesting problems with people.
                Feel free to reach out.
              </p>
            </section>

            <section aria-label="Education">
              <h2 style={{ color: "#fff", fontWeight: 700, marginBottom: "1.25rem" }}>Education</h2>
              <div style={{
                background: "#1a1a2e",
                border: "1px solid rgba(124,58,237,0.2)",
                borderRadius: "14px",
                ...
                <div>
                  ...
                  <p style={{ color: "#a855f7", fontWeight: 600, fontSize: "0.85rem", marginBottom: "0.5rem" }}>
