...
const projects = [
  {
    ...
    bannerColor: "linear-gradient(135deg, #7c3aed, #4f46e5, #0ea5e9)",
    ...
    images: [
      { color: "linear-gradient(135deg, #7c3aed, #0ea5e9)", label: "Collection Preview" },
      { color: "linear-gradient(135deg, #4f46e5, #7c3aed)", label: "Minting Site" },
      { color: "linear-gradient(135deg, #0ea5e9, #6d28d9)", label: "Brand Assets" },
    ],
  },
  {
    id: 2,
    ...
    bannerColor: "linear-gradient(135deg, #059669, #0d9488, #0ea5e9)",
    ...
    images: [
      { color: "linear-gradient(135deg, #059669, #0d9488)", label: "Dashboard" },
      { color: "linear-gradient(135deg, #0d9488, #0ea5e9)", label: "Problem View" },
    ],
  },
  {
    id: 3,
    ...
    bannerColor: "linear-gradient(135deg, #f59e0b, #ef4444, #ec4899)",
    ...
    images: [
      { color: "linear-gradient(135deg, #f59e0b, #ef4444)", label: "Chat Interface" },
      { color: "linear-gradient(135deg, #ef4444, #ec4899)", label: "Degree Planner" },
    ],
  },
  {
    id: 4,
    ...
    bannerColor: "linear-gradient(135deg, #ec4899, #f43f5e, #fb923c)",
    ...
    images: [
      { color: "linear-gradient(135deg, #ec4899, #f43f5e)", label: "Store Front" },
      { color: "linear-gradient(135deg, #f43f5e, #fb923c)", label: "Product Shots" },
      { color: "linear-gradient(135deg, #fb923c, #ec4899)", label: "Top Listings" },
    ],
  },
  {
    id: 5,
    ...
    bannerColor: "linear-gradient(135deg, #0ea5e9, #8b5cf6, #ec4899)",
    ...
    images: [
      { color: "linear-gradient(135deg, #0ea5e9, #8b5cf6)", label: "Logo Work" },
      { color: "linear-gradient(135deg, #8b5cf6, #ec4899)", label: "Brand Kits" },
      { color: "linear-gradient(135deg, #ec4899, #0ea5e9)", label: "Social Assets" },
    ],
  },
];
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(to top, rgba(15,15,31,0.7), transparent)",
            borderRadius: "20px 20px 0 0",
          }} />
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h2 style={{ color: "#fff", fontWeight: 800, margin: 0, fontSize: "1.8rem" }}>{project.title}</h2>
            <p style={{ color: "rgba(255,255,255,0.7)", margin: 0, fontSize: "0.95rem" }}>{project.tagline}</p>
          </div>
        ...
        <div style={{ padding: "2rem" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "1.5rem" }}>
            {project.details.map((d) => (
              <div key={d.label} style={{
                ...
                <div style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.7rem", fontWeight: 600, letterSpacing: "1px", textTransform: "uppercase" }}>{d.label}</div>
                <div style={{ color: "#fff", fontWeight: 600, fontSize: "0.9rem" }}>{d.value}</div>
              </div>
            ))}
          </div>
          ...
          {/* Image previews */}
          <h5 style={{ color: "#fff", fontWeight: 700, marginBottom: "1rem" }}>Preview</h5>
